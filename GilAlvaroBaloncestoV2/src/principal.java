...
public class principal {
	...
	public static void main (String args[]) {
		...
		jugadores.get(1).annadirPartidoConvocado(2, "unicaja", 1, 20, 3, 4, 5, 8);
		jugadores.get(1).annadirPartidoConvocado(3, "Barcelona", 1, 5, 3, 4, 5, 3);
		jugadores.get(2).annadirPartidoConvocado(4, "Sabadell", 5, 15, 7, 8, 9, 4);
		jugadores.get(3).annadirPartidoConvocado(5, "Estudiantes", 2, 3, 23, 10, 6, 5.5);
		jugadores.get(4).annadirPartidoConvocado(6, "Murica", 2, 35, 23, 15, 8, 3.34);
		jugadores.get(5).annadirPartidoConvocado(7, "UCAM", 2, 11, 23, 10, 6, 3.8);
		jugadores.get(6).annadirPartidoConvocado(8, "Tarragona", 2, 26, 23, 10, 6, 8.5);
		jugadores.get(7).annadirPartidoConvocado(9, "UMA", 2, 18, 23, 10, 6, 6.8);
		jugadores.get(8).annadirPartidoConvocado(10, "Badalona", 2, 5, 23, 10, 6, 2);
		jugadores.get(9).annadirPartidoConvocado(11, "Castilla", 2, 28, 23, 10, 6, 9);
