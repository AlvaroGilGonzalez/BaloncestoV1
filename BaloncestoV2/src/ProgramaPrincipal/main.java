...
public class main {
	...
	public static void main (String args[]) {
		//Creamos un arrayList de jugadores y a�adimos varios a el para poder hacer comprobaciones
		...
		//A�adimos datos de partidos a los distintos jugadores utilizando la funcion que hemos creado
		...
		do {
			...
			System.out.println("4.A�adir informacion del partido de algun jugador");
			System.out.println("5.Mostrar los partidos que ha jugado un jugador");
			//A partir de este punto encontramos las nuevas opciones del menu a�adidas en jugadores V2
			System.out.println("6.El dorsal del jugador que m�s puntos ha conseguido durante temporada.");
			System.out.println("7.El dorsal del jugador que m�s partidos ha sido convocado durante temporada.");
			...
			case 1:{
				...
				System.out.println("Introduzca la cuota que pagar� el nuevo socio");
			...
			//Creamos un nuevo jugador y lo a�adimos al arraylist jugadores
			case 3:{
			...
			//Seleccionamos el dorsal de un jugador y le a�adimos informacion sobre un partido que ha jugado
			case 4:{
			...
			//Mostramos el nombre y el dorsal del jugador que m�s puntos ha conseguido durante temporada
			case 6:{
